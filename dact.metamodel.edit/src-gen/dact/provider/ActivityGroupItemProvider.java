...
public class ActivityGroupItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addParallelNodePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DactPackage.Literals.ACTIVITY_GROUP__ACTIVITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DactPackage.Literals.ACTIVITY_GROUP__STRUCTURED_ACTIVITY_NODE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DactPackage.Literals.ACTIVITY_GROUP__CONDITIONAL_NODE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Parallel Node feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addParallelNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActivityGroup_parallelNode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActivityGroup_parallelNode_feature", "_UI_ActivityGroup_type"),
				 DactPackage.Literals.ACTIVITY_GROUP__PARALLEL_NODE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DactPackage.Literals.ACTIVITY_GROUP__OWNED_NODES);
			childrenFeatures.add(DactPackage.Literals.ACTIVITY_GROUP__OWNED_EDGES);
			childrenFeatures.add(DactPackage.Literals.ACTIVITY_GROUP__SCOPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.ACTIVITY_GROUP__OWNED_NODES,
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.ACTIVITY_GROUP__OWNED_EDGES,
				 DactFactory.eINSTANCE.createActivityEdge()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.ACTIVITY_GROUP__SCOPE,
