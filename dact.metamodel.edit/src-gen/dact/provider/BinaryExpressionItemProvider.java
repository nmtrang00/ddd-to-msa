...
public class BinaryExpressionItemProvider extends ExpressionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DactPackage.Literals.BINARY_EXPRESSION__OPERATOR);
			childrenFeatures.add(DactPackage.Literals.BINARY_EXPRESSION__LEFT_EXPR);
			childrenFeatures.add(DactPackage.Literals.BINARY_EXPRESSION__RIGHT_EXPR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.BINARY_EXPRESSION__RIGHT_EXPR,
				 DactFactory.eINSTANCE.createVariableAssignment()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DactPackage.Literals.BINARY_EXPRESSION__LEFT_EXPR ||
			childFeature == DactPackage.Literals.BINARY_EXPRESSION__RIGHT_EXPR;
