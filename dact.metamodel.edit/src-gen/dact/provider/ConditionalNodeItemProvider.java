...
public class ConditionalNodeItemProvider extends StructuredActivityNodeItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DactPackage.Literals.CONDITIONAL_NODE__ELSE_BODY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.CONDITIONAL_NODE__ELSE_BODY,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DactPackage.Literals.STRUCTURED_ACTIVITY_NODE__BODY ||
			childFeature == DactPackage.Literals.CONDITIONAL_NODE__ELSE_BODY;
