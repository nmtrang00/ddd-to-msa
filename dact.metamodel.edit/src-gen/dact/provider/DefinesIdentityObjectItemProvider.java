...
public class DefinesIdentityObjectItemProvider 
	...
	public String getText(Object object) {
		Boolean labelValue = ((DefinesIdentityObject)object).getDefinesIdentity();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_DefinesIdentityObject_type") :
			getString("_UI_DefinesIdentityObject_type") + " " + label;
	}
