...
public class DomainEventItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DactPackage.Literals.DOMAIN_OBJECT__OWNED_PROPERTIES);
			childrenFeatures.add(DactPackage.Literals.DOMAIN_OBJECT__OWNED_OPERATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.DOMAIN_OBJECT__OWNED_PROPERTIES,
				 DactFactory.eINSTANCE.createProperty()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.DOMAIN_OBJECT__OWNED_OPERATIONS,
