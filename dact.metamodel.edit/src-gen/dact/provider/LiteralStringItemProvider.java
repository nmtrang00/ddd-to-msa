...
/**
 * This is the item provider adapter for a {@link dact.LiteralString} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LiteralStringItemProvider extends LiteralItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DactPackage.Literals.LITERAL_STRING__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LiteralString_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LiteralString_length_feature", "_UI_LiteralString_type"),
				 DactPackage.Literals.LITERAL_STRING__LENGTH,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LiteralString.class)) {
			case DactPackage.LITERAL_STRING__VALUE:
			case DactPackage.LITERAL_STRING__LENGTH:
