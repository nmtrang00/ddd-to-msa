...
public class RootItemProvider extends DiagnosticSupportedItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DactPackage.Literals.ROOT__DDD);
			childrenFeatures.add(DactPackage.Literals.ROOT__ACTIVITY);
			childrenFeatures.add(DactPackage.Literals.ROOT__PRIMITIVES_TYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.ROOT__DDD,
				 DactFactory.eINSTANCE.createDddModel()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.ROOT__ACTIVITY,
				 DactFactory.eINSTANCE.createActivityModel()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.ROOT__PRIMITIVES_TYPES,
