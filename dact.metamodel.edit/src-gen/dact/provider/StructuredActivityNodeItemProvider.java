...
public class StructuredActivityNodeItemProvider extends ControlNodeItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DactPackage.Literals.STRUCTURED_ACTIVITY_NODE__TEST);
			childrenFeatures.add(DactPackage.Literals.STRUCTURED_ACTIVITY_NODE__BODY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.STRUCTURED_ACTIVITY_NODE__TEST,
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.STRUCTURED_ACTIVITY_NODE__BODY,
