...
public class UnaryExpressionItemProvider extends ExpressionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DactPackage.Literals.UNARY_EXPRESSION__VALUE);
			childrenFeatures.add(DactPackage.Literals.UNARY_EXPRESSION__IDENTIFIER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.UNARY_EXPRESSION__IDENTIFIER,
