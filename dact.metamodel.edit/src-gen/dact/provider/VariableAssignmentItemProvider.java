...
public class VariableAssignmentItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DactPackage.Literals.VARIABLE_ASSIGNMENT__IDENTIFIER);
			childrenFeatures.add(DactPackage.Literals.VARIABLE_ASSIGNMENT__EXPR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.VARIABLE_ASSIGNMENT__IDENTIFIER,
				 DactFactory.eINSTANCE.createIdentifier()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.Literals.VARIABLE_ASSIGNMENT__EXPR,
