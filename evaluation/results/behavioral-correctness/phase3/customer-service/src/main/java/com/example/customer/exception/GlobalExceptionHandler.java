...
public class GlobalExceptionHandler {
  @ExceptionHandler(DuplicateCustomer.class)
      public ResponseEntity<MessageResponse> handleAdmissionRangeException(DuplicateCustomer ex) {
  ...
  @ExceptionHandler(UnknownCustomer.class)
      public ResponseEntity<MessageResponse> handleAdmissionRangeException(UnknownCustomer ex) {
          MessageResponse errorResponse = new MessageResponse(
              "BAD_REQUEST",
              false,
              ex.getMessage()
