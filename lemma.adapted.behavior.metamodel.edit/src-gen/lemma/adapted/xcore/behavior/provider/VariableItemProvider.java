...
/**
 * This is the item provider adapter for a {@link lemma.adapted.xcore.behavior.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAccessibleScopesPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BehaviorPackage.Literals.VARIABLE__UPPER_BOUND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BehaviorPackage.Literals.VARIABLE__LOWER_BOUND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Accessible Scopes feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAccessibleScopesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_accessibleScopes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_accessibleScopes_feature", "_UI_Variable_type"),
				 BehaviorPackage.Literals.VARIABLE__ACCESSIBLE_SCOPES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BehaviorPackage.Literals.VARIABLE__SCOPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BehaviorPackage.Literals.VARIABLE__IMPORTED_TYPE);
			childrenFeatures.add(BehaviorPackage.Literals.VARIABLE__PRIMITIVE_TYPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.VARIABLE__IMPORTED_TYPE,
				 ServiceFactory.eINSTANCE.createImportedType()));

		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.VARIABLE__PRIMITIVE_TYPE,
