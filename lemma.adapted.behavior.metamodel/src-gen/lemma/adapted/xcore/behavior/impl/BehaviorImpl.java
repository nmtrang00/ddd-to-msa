 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.behavior.impl.BehaviorImpl#getSpecification <em>Specification</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public void setSpecification(ImportedOperation newSpecification) {
		if (newSpecification != specification) {
			...
			if (specification != null)
				msgs = ((InternalEObject)specification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BehaviorPackage.BEHAVIOR__SPECIFICATION, null, msgs);
			if (newSpecification != null)
				msgs = ((InternalEObject)newSpecification).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BehaviorPackage.BEHAVIOR__SPECIFICATION, null, msgs);
