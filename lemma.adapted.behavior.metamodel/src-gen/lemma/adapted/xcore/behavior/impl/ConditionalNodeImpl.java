 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.behavior.impl.ConditionalNodeImpl#getElseBody <em>Else Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionalNodeImpl extends StructuredActivityNodeImpl implements ConditionalNode {
	...
	protected EClass eStaticClass() {
		return BehaviorPackage.Literals.CONDITIONAL_NODE;
	}
	...
	public NotificationChain basicSetElseBody(ActivityGroup newElseBody, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BehaviorPackage.CONDITIONAL_NODE__ELSE_BODY, oldElseBody, newElseBody);
	...
	public void setElseBody(ActivityGroup newElseBody) {
		if (newElseBody != elseBody) {
			...
			if (elseBody != null)
				msgs = ((InternalEObject)elseBody).eInverseRemove(this, BehaviorPackage.ACTIVITY_GROUP__CONDITIONAL_NODE, ActivityGroup.class, msgs);
			if (newElseBody != null)
				msgs = ((InternalEObject)newElseBody).eInverseAdd(this, BehaviorPackage.ACTIVITY_GROUP__CONDITIONAL_NODE, ActivityGroup.class, msgs);
			msgs = basicSetElseBody(newElseBody, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviorPackage.CONDITIONAL_NODE__ELSE_BODY, newElseBody, newElseBody));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviorPackage.CONDITIONAL_NODE__ELSE_BODY:
				if (elseBody != null)
					msgs = ((InternalEObject)elseBody).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BehaviorPackage.CONDITIONAL_NODE__ELSE_BODY, null, msgs);
