 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.behavior.impl.FinalNodeImpl#getVariablesToReturn <em>Variables To Return</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FinalNodeImpl extends ControlNodeImpl implements FinalNode {
	...
	protected EClass eStaticClass() {
		return BehaviorPackage.Literals.FINAL_NODE;
	}
	...
	public EList<Identifier> getVariablesToReturn() {
		if (variablesToReturn == null) {
			variablesToReturn = new EObjectContainmentEList<Identifier>(Identifier.class, this, BehaviorPackage.FINAL_NODE__VARIABLES_TO_RETURN);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviorPackage.FINAL_NODE__VARIABLES_TO_RETURN:
