 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.behavior.impl.VariableAssignmentActionImpl#getAssignment <em>Assignment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableAssignmentActionImpl extends ExecutableNodeImpl implements VariableAssignmentAction {
	...
	protected EClass eStaticClass() {
		return BehaviorPackage.Literals.VARIABLE_ASSIGNMENT_ACTION;
	}
	...
	public NotificationChain basicSetAssignment(VariableAssignment newAssignment, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BehaviorPackage.VARIABLE_ASSIGNMENT_ACTION__ASSIGNMENT, oldAssignment, newAssignment);
	...
	public void setAssignment(VariableAssignment newAssignment) {
		if (newAssignment != assignment) {
			...
			if (assignment != null)
				msgs = ((InternalEObject)assignment).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BehaviorPackage.VARIABLE_ASSIGNMENT_ACTION__ASSIGNMENT, null, msgs);
			if (newAssignment != null)
				msgs = ((InternalEObject)newAssignment).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BehaviorPackage.VARIABLE_ASSIGNMENT_ACTION__ASSIGNMENT, null, msgs);
			msgs = basicSetAssignment(newAssignment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviorPackage.VARIABLE_ASSIGNMENT_ACTION__ASSIGNMENT, newAssignment, newAssignment));
	}
