 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.data.DataField#getName <em>Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataField#isHidden <em>Hidden</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataField#isImmutable <em>Immutable</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataField#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataField#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataField#getComplexType <em>Complex Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataField#getImportedComplexType <em>Imported Complex Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataField#getPrimitiveType <em>Primitive Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataField#getInitializationValue <em>Initialization Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataField#getFeatures <em>Features</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataField#getDataStructure <em>Data Structure</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataField#getCollectionType <em>Collection Type</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.data.DataPackage#getDataField()
 * @model
 * @generated
 */
public interface DataField extends EObject {
	 ...
	 *          Ensured by: DSL validator.
	 * ADAPTED: lowerBounded + upperBounded -> Has meaning for Collection Type only!
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>Name</em>' attribute.
	 * @see #setName(String)
	 * @see lemma.adapted.xcore.data.DataPackage#getDataField_Name()
	 * @model unique="false"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.DataField#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getDataField_Hidden()
	 * @model unique="false"
	 * @generated
	 */
	boolean isHidden();
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.DataField#isHidden <em>Hidden</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getDataField_Immutable()
	 * @model unique="false"
	 * @generated
	 */
	boolean isImmutable();
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.DataField#isImmutable <em>Immutable</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getDataField_LowerBound()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.DataField#getLowerBound <em>Lower Bound</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getDataField_UpperBound()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.DataField#getUpperBound <em>Upper Bound</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getDataField_ComplexType()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.DataField#getComplexType <em>Complex Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.data.ImportedComplexType#getDataField <em>Data Field</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Imported Complex Type</em>' containment reference.
	 * @see #setImportedComplexType(ImportedComplexType)
	 * @see lemma.adapted.xcore.data.DataPackage#getDataField_ImportedComplexType()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.DataField#getImportedComplexType <em>Imported Complex Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getDataField_PrimitiveType()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.DataField#getPrimitiveType <em>Primitive Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getDataField_InitializationValue()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.DataField#getInitializationValue <em>Initialization Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link lemma.adapted.xcore.data.DataFieldFeature}.
	 * The literals are from the enumeration {@link lemma.adapted.xcore.data.DataFieldFeature}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Features</em>' attribute list.
	 * @see lemma.adapted.xcore.data.DataFieldFeature
	 * @see lemma.adapted.xcore.data.DataPackage#getDataField_Features()
	 * @model unique="false"
	 * @generated
	 */
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.data.DataStructure#getDataFields <em>Data Fields</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Data Structure</em>' container reference.
	 * @see #setDataStructure(DataStructure)
	 * @see lemma.adapted.xcore.data.DataPackage#getDataField_DataStructure()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.DataField#getDataStructure <em>Data Structure</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.data.CollectionType#getDataFields <em>Data Fields</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Collection Type</em>' container reference.
	 * @see #setCollectionType(CollectionType)
	 * @see lemma.adapted.xcore.data.DataPackage#getDataField_CollectionType()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.DataField#getCollectionType <em>Collection Type</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
