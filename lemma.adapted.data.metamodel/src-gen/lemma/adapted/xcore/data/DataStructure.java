 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.data.DataStructure#getSuper <em>Super</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataStructure#getDataFields <em>Data Fields</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.DataStructure#getOperations <em>Operations</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.data.DataPackage#getDataStructure()
 * @model
 * @generated
 */
public interface DataStructure extends ComplexType {
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getDataStructure_Super()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.DataStructure#getSuper <em>Super</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link lemma.adapted.xcore.data.DataField}.
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.data.DataField#getDataStructure <em>Data Structure</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Data Fields</em>' containment reference list.
	 * @see lemma.adapted.xcore.data.DataPackage#getDataStructure_DataFields()
	 ...
	 * The list contents are of type {@link lemma.adapted.xcore.data.DataOperation}.
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.data.DataOperation#getDataStructure <em>Data Structure</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Operations</em>' containment reference list.
	 * @see lemma.adapted.xcore.data.DataPackage#getDataStructure_Operations()
