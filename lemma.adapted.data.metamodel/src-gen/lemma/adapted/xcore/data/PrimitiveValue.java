 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.data.PrimitiveValue#getStringValue <em>String Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.PrimitiveValue#getBooleanValue <em>Boolean Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.PrimitiveValue#getNumericValue <em>Numeric Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.PrimitiveValue#getLength <em>Length</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.data.DataPackage#getPrimitiveValue()
 * @model
 * @generated
 */
public interface PrimitiveValue extends ValueSpecification {
	/**
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getPrimitiveValue_StringValue()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.PrimitiveValue#getStringValue <em>String Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getPrimitiveValue_BooleanValue()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.PrimitiveValue#getBooleanValue <em>Boolean Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getPrimitiveValue_NumericValue()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.PrimitiveValue#getNumericValue <em>Numeric Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getPrimitiveValue_Length()
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="lemma.adapted.xcore.data.TypeNameSizeMap" unique="false"
	 * @generated
	 */
