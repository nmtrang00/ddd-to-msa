 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataModelImpl#getT_modelUri <em>Tmodel Uri</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataModelImpl#getComplexTypeImports <em>Complex Type Imports</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataModelImpl#getVersions <em>Versions</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataModelImpl#getContexts <em>Contexts</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataModelImpl#getComplexTypes <em>Complex Types</em>}</li>
 * </ul>
 *
 * @generated
 */
