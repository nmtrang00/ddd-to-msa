 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationImpl#isHidden <em>Hidden</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationImpl#isHasNoReturnType <em>Has No Return Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationImpl#getOperationType <em>Operation Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationImpl#getDataStructure <em>Data Structure</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationImpl#isInherited <em>Inherited</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataOperationImpl extends MinimalEObjectImpl.Container implements DataOperation {
	...
	public void setOperationType(OperationType newOperationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.DATA_OPERATION__OPERATION_TYPE, oldOperationType, operationType));
	}
