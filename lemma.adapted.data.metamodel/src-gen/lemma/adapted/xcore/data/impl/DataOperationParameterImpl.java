 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationParameterImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationParameterImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationParameterImpl#getExchangePattern <em>Exchange Pattern</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationParameterImpl#getComplexType <em>Complex Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationParameterImpl#getImportedComplexType <em>Imported Complex Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationParameterImpl#getPrimitiveType <em>Primitive Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationParameterImpl#getInitializationValue <em>Initialization Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataOperationParameterImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataOperationParameterImpl extends MinimalEObjectImpl.Container implements DataOperationParameter {
	...
	public void setLowerBound(Integer newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.DATA_OPERATION_PARAMETER__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(Integer newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.DATA_OPERATION_PARAMETER__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public void setExchangePattern(ExchangePattern newExchangePattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.DATA_OPERATION_PARAMETER__EXCHANGE_PATTERN, oldExchangePattern, exchangePattern));
	}
	...
	public NotificationChain basicSetInitializationValue(PrimitiveValue newInitializationValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataPackage.DATA_OPERATION_PARAMETER__INITIALIZATION_VALUE, oldInitializationValue, newInitializationValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInitializationValue(PrimitiveValue newInitializationValue) {
		if (newInitializationValue != initializationValue) {
			...
			if (initializationValue != null)
				msgs = ((InternalEObject)initializationValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DataPackage.DATA_OPERATION_PARAMETER__INITIALIZATION_VALUE, null, msgs);
			if (newInitializationValue != null)
				msgs = ((InternalEObject)newInitializationValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DataPackage.DATA_OPERATION_PARAMETER__INITIALIZATION_VALUE, null, msgs);
			msgs = basicSetInitializationValue(newInitializationValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.DATA_OPERATION_PARAMETER__INITIALIZATION_VALUE, newInitializationValue, newInitializationValue));
	}
