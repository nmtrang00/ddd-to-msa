/**
 */
package lemma.adapted.xcore.data.impl;
...
import lemma.adapted.xcore.data.PrimitiveBoolean;
import lemma.adapted.xcore.data.PrimitiveByte;
import lemma.adapted.xcore.data.PrimitiveCharacter;
import lemma.adapted.xcore.data.PrimitiveDate;
import lemma.adapted.xcore.data.PrimitiveDouble;
import lemma.adapted.xcore.data.PrimitiveFloat;
import lemma.adapted.xcore.data.PrimitiveInteger;
import lemma.adapted.xcore.data.PrimitiveLong;
import lemma.adapted.xcore.data.PrimitiveShort;
import lemma.adapted.xcore.data.PrimitiveString;
import lemma.adapted.xcore.data.PrimitiveType;
import lemma.adapted.xcore.data.PrimitiveTypeConstants;
import lemma.adapted.xcore.data.PrimitiveUnspecified;
...
public class DataPackageImpl extends EPackageImpl implements DataPackage {
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EAttribute getDataOperation_OperationType() {
		return (EAttribute)dataOperationEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getDataOperationParameter_LowerBound() {
		return (EAttribute)dataOperationParameterEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getDataOperationParameter_UpperBound() {
		return (EAttribute)dataOperationParameterEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getDataOperationParameter_ExchangePattern() {
		return (EAttribute)dataOperationParameterEClass.getEStructuralFeatures().get(3);
	}
	...
	public EReference getDataOperationParameter_ImportedComplexType() {
		return (EReference)dataOperationParameterEClass.getEStructuralFeatures().get(5);
	}
	...
	public EReference getDataOperationParameter_PrimitiveType() {
		return (EReference)dataOperationParameterEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EReference getDataOperationParameter_InitializationValue() {
		return (EReference)dataOperationParameterEClass.getEStructuralFeatures().get(7);
	}
	...
	public EReference getDataOperationParameter_Operation() {
		return (EReference)dataOperationParameterEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EAttribute getDataField_LowerBound() {
	 ...
	 */
	@Override
	public EAttribute getDataField_UpperBound() {
	...
	public EAttribute getDataField_Features() {
		return (EAttribute)dataFieldEClass.getEStructuralFeatures().get(9);
	}
	...
	public EReference getDataField_DataStructure() {
		return (EReference)dataFieldEClass.getEStructuralFeatures().get(10);
	}
	...
	public EReference getDataField_CollectionType() {
		return (EReference)dataFieldEClass.getEStructuralFeatures().get(11);
	}
	 ...
	 */
	@Override
	public EAttribute getPrimitiveValue_Length() {
		return (EAttribute)primitiveValueEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EOperation getPrimitiveValue__Contains__String() {
	...
	public void createPackageContents() {
		...
		createEAttribute(dataOperationEClass, DATA_OPERATION__OPERATION_TYPE);
		...
		createEAttribute(dataOperationParameterEClass, DATA_OPERATION_PARAMETER__LOWER_BOUND);
		createEAttribute(dataOperationParameterEClass, DATA_OPERATION_PARAMETER__UPPER_BOUND);
		createEAttribute(dataOperationParameterEClass, DATA_OPERATION_PARAMETER__EXCHANGE_PATTERN);
		...
		createEReference(dataOperationParameterEClass, DATA_OPERATION_PARAMETER__INITIALIZATION_VALUE);
		...
		createEAttribute(dataFieldEClass, DATA_FIELD__LOWER_BOUND);
		createEAttribute(dataFieldEClass, DATA_FIELD__UPPER_BOUND);
		...
		createEAttribute(primitiveValueEClass, PRIMITIVE_VALUE__LENGTH);
		createEOperation(primitiveValueEClass, PRIMITIVE_VALUE___CONTAINS__STRING);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDataOperation_OperationType(), this.getOperationType(), "operationType", null, 0, 1, DataOperation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDataOperationParameter_LowerBound(), theEcorePackage.getEIntegerObject(), "lowerBound", null, 0, 1, DataOperationParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDataOperationParameter_UpperBound(), theEcorePackage.getEIntegerObject(), "upperBound", null, 0, 1, DataOperationParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDataOperationParameter_ExchangePattern(), this.getExchangePattern(), "exchangePattern", null, 0, 1, DataOperationParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDataOperationParameter_InitializationValue(), this.getPrimitiveValue(), null, "initializationValue", null, 0, 1, DataOperationParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDataField_LowerBound(), theEcorePackage.getEIntegerObject(), "lowerBound", null, 0, 1, DataField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDataField_UpperBound(), theEcorePackage.getEIntegerObject(), "upperBound", null, 0, 1, DataField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPrimitiveValue_Length(), theEcorePackage.getEIntegerObject(), "length", null, 0, 1, PrimitiveValue.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		op = initEOperation(getPrimitiveValue__Contains__String(), theEcorePackage.getEBooleanObject(), "contains", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEString(), "substring", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		addEEnumLiteral(complexTypeFeatureEEnum, ComplexTypeFeature.REQUEST_PAYLOAD);
		addEEnumLiteral(complexTypeFeatureEEnum, ComplexTypeFeature.RESPONSE_PAYLOAD);
		addEEnumLiteral(complexTypeFeatureEEnum, ComplexTypeFeature.NOTFOUND_EXCEPTION);
		addEEnumLiteral(complexTypeFeatureEEnum, ComplexTypeFeature.RUNTIME_EXCEPTION);
		...
		addEEnumLiteral(complexTypeFeatureEEnum, ComplexTypeFeature.SHARED_VALUE_OBJECT);
		addEEnumLiteral(complexTypeFeatureEEnum, ComplexTypeFeature.EXTERNAL);
		...
		addEEnumLiteral(operationTypeEEnum, OperationType.I0_INBOUND_GET);
		addEEnumLiteral(operationTypeEEnum, OperationType.I1_INBOUND_PUT);
		addEEnumLiteral(operationTypeEEnum, OperationType.I2_INBOUND_POST);
		addEEnumLiteral(operationTypeEEnum, OperationType.I3_INBOUND_DELETE);
		addEEnumLiteral(operationTypeEEnum, OperationType.I4_MESSAGE_HANDLER);
		addEEnumLiteral(operationTypeEEnum, OperationType.S0_DOMAIN_SERVICE);
		addEEnumLiteral(operationTypeEEnum, OperationType.S1_APPLICATION_SERVICE);
		addEEnumLiteral(operationTypeEEnum, OperationType.R0_REPOSITORY_CREATE);
		addEEnumLiteral(operationTypeEEnum, OperationType.R1_REPOSITORY_READ);
		addEEnumLiteral(operationTypeEEnum, OperationType.R2_REPOSITORY_CREATE);
		addEEnumLiteral(operationTypeEEnum, OperationType.R3_REPOSITORY_DELETE);
		addEEnumLiteral(operationTypeEEnum, OperationType.R4_REPOSITORY_EXIST);
		addEEnumLiteral(operationTypeEEnum, OperationType.O0_OUTBOUND_GET);
		addEEnumLiteral(operationTypeEEnum, OperationType.O1_OUTBOUND_PUT);
		addEEnumLiteral(operationTypeEEnum, OperationType.O2_OUTBOUND_POST);
		addEEnumLiteral(operationTypeEEnum, OperationType.O3_OUTBOUND_DELETE);
		addEEnumLiteral(operationTypeEEnum, OperationType.O4_MESSAGE_DISPATCHER);
		addEEnumLiteral(operationTypeEEnum, OperationType.O5_OUTBOX_POLLER);
		addEEnumLiteral(operationTypeEEnum, OperationType.D0_CONSTRUCTOR);
		addEEnumLiteral(operationTypeEEnum, OperationType.D1_SIMPLE_MUTATOR);
		addEEnumLiteral(operationTypeEEnum, OperationType.D2_COMPOUND_MUTATOR);
		addEEnumLiteral(operationTypeEEnum, OperationType.D3_SIMPLE_ACCESSOR);
		addEEnumLiteral(operationTypeEEnum, OperationType.D4_COMPOUND_ACCESSOR);
		addEEnumLiteral(operationTypeEEnum, OperationType.D5_SPECIFICATION);
		addEEnumLiteral(operationTypeEEnum, OperationType.A0_INTERNAL_ACL);
		addEEnumLiteral(operationTypeEEnum, OperationType.A1_EXTERNAL_ACL);
