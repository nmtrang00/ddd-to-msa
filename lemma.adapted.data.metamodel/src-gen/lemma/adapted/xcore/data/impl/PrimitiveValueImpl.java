 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.data.impl.PrimitiveValueImpl#getStringValue <em>String Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.PrimitiveValueImpl#getBooleanValue <em>Boolean Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.PrimitiveValueImpl#getNumericValue <em>Numeric Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.PrimitiveValueImpl#getLength <em>Length</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveValueImpl extends ValueSpecificationImpl implements PrimitiveValue {
	/**
	...
	public Integer getLength() {
		...
		return Integer.valueOf(this.getStringValue().length());
	}
	...
	public Boolean contains(final String substring) {
		if (((this.getStringValue() == null) || (substring == null))) {
			return Boolean.valueOf(false);
		}
		return Boolean.valueOf(this.getStringValue().contains(substring));
	}
	...
	public Map<String, Integer> inferCompatibleTypes() {
		...
		boolean _tripleNotEquals_8 = (_asString != null);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DataPackage.PRIMITIVE_VALUE__LENGTH:
				return getLength();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DataPackage.PRIMITIVE_VALUE___CONTAINS__STRING:
