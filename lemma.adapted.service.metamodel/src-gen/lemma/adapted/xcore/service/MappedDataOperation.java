 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.service.MappedDataOperation#getDataOperation <em>Data Operation</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.MappedDataOperation#getAspects <em>Aspects</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.MappedDataOperation#getMappedReturnType <em>Mapped Return Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.MappedDataOperation#getMappedParameters <em>Mapped Parameters</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.MappedDataOperation#getMappedComplexType <em>Mapped Complex Type</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.service.ServicePackage#getMappedDataOperation()
 * @model
 * @generated
 */
public interface MappedDataOperation extends EObject {
	 ...
	 * @see lemma.adapted.xcore.service.ServicePackage#getMappedDataOperation_DataOperation()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.MappedDataOperation#getDataOperation <em>Data Operation</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.service.ImportedServiceAspect#getMappedDataOperation <em>Mapped Data Operation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Aspects</em>' containment reference list.
	 * @see lemma.adapted.xcore.service.ServicePackage#getMappedDataOperation_Aspects()
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.service.MappedDataOperationReturnType#getMappedOperation <em>Mapped Operation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.service.ServicePackage#getMappedDataOperation_MappedReturnType()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.MappedDataOperation#getMappedReturnType <em>Mapped Return Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link lemma.adapted.xcore.service.MappedDataOperationParameter}.
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.service.MappedDataOperationParameter#getMappedOperation <em>Mapped Operation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Mapped Parameters</em>' containment reference list.
	 * @see lemma.adapted.xcore.service.ServicePackage#getMappedDataOperation_MappedParameters()
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.service.MappedComplexType#getMappedOperations <em>Mapped Operations</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Mapped Complex Type</em>' container reference.
	 * @see #setMappedComplexType(MappedComplexType)
	 * @see lemma.adapted.xcore.service.ServicePackage#getMappedDataOperation_MappedComplexType()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.MappedDataOperation#getMappedComplexType <em>Mapped Complex Type</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
