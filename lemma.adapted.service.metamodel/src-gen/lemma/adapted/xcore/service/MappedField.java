 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.service.MappedField#getDataField <em>Data Field</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.MappedField#getEnumerationField <em>Enumeration Field</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.MappedField#getMappedType <em>Mapped Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.MappedField#getAspects <em>Aspects</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.MappedField#getParameter <em>Parameter</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.MappedField#getMappedComplexType <em>Mapped Complex Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.MappedField#getName <em>Name</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.service.ServicePackage#getMappedField()
 * @model
 * @generated
 */
public interface MappedField extends EObject {
	 ...
	 * @see lemma.adapted.xcore.service.ServicePackage#getMappedField_DataField()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.MappedField#getDataField <em>Data Field</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.service.ServicePackage#getMappedField_EnumerationField()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.MappedField#getEnumerationField <em>Enumeration Field</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.service.ServicePackage#getMappedField_MappedType()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.MappedField#getMappedType <em>Mapped Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.service.ImportedServiceAspect#getMappedField <em>Mapped Field</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Aspects</em>' containment reference list.
	 * @see lemma.adapted.xcore.service.ServicePackage#getMappedField_Aspects()
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.service.Parameter#getMappedFields <em>Mapped Fields</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Parameter</em>' container reference.
	 * @see #setParameter(Parameter)
	 * @see lemma.adapted.xcore.service.ServicePackage#getMappedField_Parameter()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.MappedField#getParameter <em>Parameter</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.service.MappedComplexType#getMappedFields <em>Mapped Fields</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Mapped Complex Type</em>' container reference.
	 * @see #setMappedComplexType(MappedComplexType)
	 * @see lemma.adapted.xcore.service.ServicePackage#getMappedField_MappedComplexType()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.MappedField#getMappedComplexType <em>Mapped Complex Type</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.service.ServicePackage#getMappedField_Name()
