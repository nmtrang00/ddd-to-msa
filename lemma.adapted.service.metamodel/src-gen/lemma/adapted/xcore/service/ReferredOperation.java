 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.service.ReferredOperation#getOperation <em>Operation</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.ReferredOperation#getEndpoints <em>Endpoints</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.ReferredOperation#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.ReferredOperation#getAspects <em>Aspects</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.ReferredOperation#getInterface <em>Interface</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.service.ServicePackage#getReferredOperation()
 * @model
 * @generated
 */
public interface ReferredOperation extends EObject {
	 ...
	 * @see lemma.adapted.xcore.service.ServicePackage#getReferredOperation_Operation()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.ReferredOperation#getOperation <em>Operation</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.service.Endpoint#getReferredOperation <em>Referred Operation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Endpoints</em>' containment reference list.
	 * @see lemma.adapted.xcore.service.ServicePackage#getReferredOperation_Endpoints()
	 ...
	 * @see lemma.adapted.xcore.service.ServicePackage#getReferredOperation_Protocols()
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.service.ImportedServiceAspect#getReferredOperation <em>Referred Operation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Aspects</em>' containment reference list.
	 * @see lemma.adapted.xcore.service.ServicePackage#getReferredOperation_Aspects()
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.service.Interface#getReferredOperations <em>Referred Operations</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Interface</em>' container reference.
	 * @see #setInterface(Interface)
	 * @see lemma.adapted.xcore.service.ServicePackage#getReferredOperation_Interface()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.ReferredOperation#getInterface <em>Interface</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
