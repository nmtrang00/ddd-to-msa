 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getImport <em>Import</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getImportedAspect <em>Imported Aspect</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getSinglePropertyValue <em>Single Property Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getValues <em>Values</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getMicroservice <em>Microservice</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getInterface <em>Interface</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getReferredOperation <em>Referred Operation</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getMappedComplexType <em>Mapped Complex Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getMappedField <em>Mapped Field</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getMappedDataOperation <em>Mapped Data Operation</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getMappedDataOperationReturnType <em>Mapped Data Operation Return Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ImportedServiceAspectImpl#getMappedDataOperationParameter <em>Mapped Data Operation Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
