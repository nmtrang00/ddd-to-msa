 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#getName <em>Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#isNotImplemented <em>Not Implemented</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#getInterfaceType <em>Interface Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#getEndpoints <em>Endpoints</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#getOperations <em>Operations</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#getReferredOperations <em>Referred Operations</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#getAspects <em>Aspects</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#getMicroservice <em>Microservice</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#getEffectiveVisibility <em>Effective Visibility</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#isEffectivelyImplemented <em>Effectively Implemented</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.InterfaceImpl#isEffectivelyInternal <em>Effectively Internal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceImpl extends MinimalEObjectImpl.Container implements Interface {
	 ...
	 * @ordered
	 */
	protected static final InterfaceType INTERFACE_TYPE_EDEFAULT = InterfaceType.CONTROLLER;
	...
	public void setInterfaceType(InterfaceType newInterfaceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.INTERFACE__INTERFACE_TYPE, oldInterfaceType, interfaceType));
	}
