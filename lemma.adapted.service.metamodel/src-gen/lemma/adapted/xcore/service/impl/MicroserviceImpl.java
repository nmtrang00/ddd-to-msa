 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getName <em>Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getType <em>Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getT_defaultProtocols <em>Tdefault Protocols</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getT_sourceModelUri <em>Tsource Model Uri</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getT_mappingModelUri <em>Tmapping Model Uri</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getTechnologyReferences <em>Technology References</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getT_typeDefinitionTechnologyImport <em>Ttype Definition Technology Import</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getT_typeDefinitionTechnology <em>Ttype Definition Technology</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getEndpoints <em>Endpoints</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getRequiredMicroservices <em>Required Microservices</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getRequiredInterfaces <em>Required Interfaces</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getRequiredOperations <em>Required Operations</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getInterfaces <em>Interfaces</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getAspects <em>Aspects</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getServiceModel <em>Service Model</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#isEffectivelyImplemented <em>Effectively Implemented</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#getEffectiveVisibility <em>Effective Visibility</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MicroserviceImpl#isEffectivelyInternal <em>Effectively Internal</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public EList<Operation> getAllRequiredOperations(final Import fromImport) {
		...
		if (((this.getRequiredOperations() != null) && (!this.getRequiredOperations().isEmpty()))) {
			final Function1<PossiblyImportedOperation, Boolean> _function = new Function1<PossiblyImportedOperation, Boolean>() {
				public Boolean apply(final PossiblyImportedOperation it) {
					return Boolean.valueOf((Objects.equals(it.getImport(), fromImport) && 
