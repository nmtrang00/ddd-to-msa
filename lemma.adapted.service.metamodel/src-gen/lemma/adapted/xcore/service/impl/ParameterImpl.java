 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getExchangePattern <em>Exchange Pattern</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getCommunicationType <em>Communication Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#isCommunicatesFault <em>Communicates Fault</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#isOptional <em>Optional</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getAdapterParameterType <em>Adapter Parameter Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getInitializationValue <em>Initialization Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getInitializedByOperation <em>Initialized By Operation</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getImportedType <em>Imported Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getPrimitiveType <em>Primitive Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getAspects <em>Aspects</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getMappedFields <em>Mapped Fields</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getOriginalImportedType <em>Original Imported Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getOriginalPrimitiveType <em>Original Primitive Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.ParameterImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterImpl extends MinimalEObjectImpl.Container implements Parameter {
	...
	/**
	 * The default value of the '{@link #getAdapterParameterType() <em>Adapter Parameter Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final AdapterParameterType ADAPTER_PARAMETER_TYPE_EDEFAULT = AdapterParameterType.PATH_PARAM;

	/**
	 * The cached value of the '{@link #getAdapterParameterType() <em>Adapter Parameter Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAdapterParameterType()
	 * @generated
	 * @ordered
	 */
	protected AdapterParameterType adapterParameterType = ADAPTER_PARAMETER_TYPE_EDEFAULT;
	...
	public void setLowerBound(Integer newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.PARAMETER__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(Integer newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.PARAMETER__UPPER_BOUND, oldUpperBound, upperBound));
	}
	 ...
	 */
	@Override
	public AdapterParameterType getAdapterParameterType() {
		return adapterParameterType;
	}
	 ...
	 */
	@Override
	public void setAdapterParameterType(AdapterParameterType newAdapterParameterType) {
		AdapterParameterType oldAdapterParameterType = adapterParameterType;
		adapterParameterType = newAdapterParameterType == null ? ADAPTER_PARAMETER_TYPE_EDEFAULT : newAdapterParameterType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.PARAMETER__ADAPTER_PARAMETER_TYPE, oldAdapterParameterType, adapterParameterType));
	}
	...
	public NotificationChain basicSetInitializationValue(PrimitiveValue newInitializationValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ServicePackage.PARAMETER__INITIALIZATION_VALUE, oldInitializationValue, newInitializationValue);
	...
	public void setInitializationValue(PrimitiveValue newInitializationValue) {
		if (newInitializationValue != initializationValue) {
			...
			if (initializationValue != null)
				msgs = ((InternalEObject)initializationValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ServicePackage.PARAMETER__INITIALIZATION_VALUE, null, msgs);
			if (newInitializationValue != null)
				msgs = ((InternalEObject)newInitializationValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ServicePackage.PARAMETER__INITIALIZATION_VALUE, null, msgs);
			msgs = basicSetInitializationValue(newInitializationValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.PARAMETER__INITIALIZATION_VALUE, newInitializationValue, newInitializationValue));
	}
	...
	public boolean basicallyInitializableBy(final Operation initializingOperation) {
		...
		boolean _equals = Objects.equals(initializingOperation, _operation);
		if (_equals) {
			return false;
		}
		...
		final boolean initializingOperationFromSameMicroservice = Objects.equals(thisMicroservice, initializingMicroservice);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ServicePackage.PARAMETER__ADAPTER_PARAMETER_TYPE:
				return getAdapterParameterType();
			case ServicePackage.PARAMETER__INITIALIZATION_VALUE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ServicePackage.PARAMETER__UPPER_BOUND:
				...
				return;
			case ServicePackage.PARAMETER__ADAPTER_PARAMETER_TYPE:
				setAdapterParameterType((AdapterParameterType)newValue);
				return;
			case ServicePackage.PARAMETER__INITIALIZATION_VALUE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ServicePackage.PARAMETER__UPPER_BOUND:
				...
				return;
			case ServicePackage.PARAMETER__ADAPTER_PARAMETER_TYPE:
				setAdapterParameterType(ADAPTER_PARAMETER_TYPE_EDEFAULT);
				return;
			case ServicePackage.PARAMETER__INITIALIZATION_VALUE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ServicePackage.PARAMETER__ADAPTER_PARAMETER_TYPE:
				return adapterParameterType != ADAPTER_PARAMETER_TYPE_EDEFAULT;
			case ServicePackage.PARAMETER__INITIALIZATION_VALUE:
	...
	public String toString() {
		...
		result.append(upperBound);
		result.append(", adapterParameterType: ");
		result.append(adapterParameterType);
		result.append(')');
