/**
 */
package lemma.adapted.xcore.service.impl;
...
public class ServicePackageImpl extends EPackageImpl implements ServicePackage {
	 ...
	 * @generated
	 */
	private EEnum adapterParameterTypeEEnum = null;
	 ...
	 * @see lemma.adapted.xcore.service.ServicePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EAttribute getOperation_EffectivelyInternal() {
		return (EAttribute)operationEClass.getEStructuralFeatures().get(13);
	}
	 ...
	 */
	@Override
	public EAttribute getParameter_AdapterParameterType() {
	 ...
	 */
	@Override
	public EReference getParameter_InitializationValue() {
	...
	public EReference getParameter_OriginalPrimitiveType() {
		return (EReference)parameterEClass.getEStructuralFeatures().get(15);
	}
	 ...
	 */
	@Override
	public EEnum getAdapterParameterType() {
		return adapterParameterTypeEEnum;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(parameterEClass, PARAMETER__ADAPTER_PARAMETER_TYPE);
		createEReference(parameterEClass, PARAMETER__INITIALIZATION_VALUE);
		...
		adapterParameterTypeEEnum = createEEnum(ADAPTER_PARAMETER_TYPE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getInterface_InterfaceType(), this.getInterfaceType(), "interfaceType", null, 0, 1, Interface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getOperation_OperationType(), this.getOperationType(), "operationType", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getParameter_LowerBound(), theEcorePackage.getEIntegerObject(), "lowerBound", null, 0, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParameter_UpperBound(), theEcorePackage.getEIntegerObject(), "upperBound", null, 0, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParameter_AdapterParameterType(), this.getAdapterParameterType(), "adapterParameterType", null, 0, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getParameter_InitializationValue(), theDataPackage.getPrimitiveValue(), null, "initializationValue", null, 0, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(interfaceTypeEEnum, InterfaceType.CONTROLLER);
		addEEnumLiteral(interfaceTypeEEnum, InterfaceType.MESSAGE_HANDLER);
		addEEnumLiteral(interfaceTypeEEnum, InterfaceType.APPLICATION_SERVICE);
		addEEnumLiteral(interfaceTypeEEnum, InterfaceType.DOMAIN_SERVICE);
		addEEnumLiteral(interfaceTypeEEnum, InterfaceType.REPOSITORY);
		addEEnumLiteral(interfaceTypeEEnum, InterfaceType.OUTBOUND_ADAPTER);
		addEEnumLiteral(interfaceTypeEEnum, InterfaceType.MESSAGE_WORKER);
		...
		addEEnumLiteral(operationTypeEEnum, OperationType.R2_REPOSITORY_UPDATE);
		...
		initEEnum(adapterParameterTypeEEnum, AdapterParameterType.class, "AdapterParameterType");
		addEEnumLiteral(adapterParameterTypeEEnum, AdapterParameterType.PATH_PARAM);
		addEEnumLiteral(adapterParameterTypeEEnum, AdapterParameterType.QUERY_PARAM);
		addEEnumLiteral(adapterParameterTypeEEnum, AdapterParameterType.REQUEST_BODY);
		addEEnumLiteral(adapterParameterTypeEEnum, AdapterParameterType.RESPONSE_BODY);
		...
		initEDataType(microserviceImportMapEDataType, Map.class, "MicroserviceImportMap", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS, "java.util.Map<lemma.adapted.xcore.service.Microservice, lemma.adapted.xcore.service.Import>");
		initEDataType(defaultProtocolsEDataType, Map.class, "DefaultProtocols", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS, "java.util.Map<lemma.adapted.xcore.technology.CommunicationType, org.eclipse.xtext.xbase.lib.Pair<lemma.adapted.xcore.service.Import, lemma.adapted.xcore.technology.Protocol>>");
