 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.technology.CompatibilityMatrixEntry#getDirection <em>Direction</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.CompatibilityMatrixEntry#getMappingType <em>Mapping Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.CompatibilityMatrixEntry#getCompatibleTypes <em>Compatible Types</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.CompatibilityMatrixEntry#getTechnology <em>Technology</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.technology.TechnologyPackage#getCompatibilityMatrixEntry()
 * @model
 * @generated
 */
public interface CompatibilityMatrixEntry extends EObject {
	 ...
	 * The literals are from the enumeration {@link lemma.adapted.xcore.technology.CompatibilityDirection}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * *
	 ...
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getCompatibilityMatrixEntry_Direction()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.CompatibilityMatrixEntry#getDirection <em>Direction</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.technology.PossiblyImportedTechnologySpecificType#getMappingEntry <em>Mapping Entry</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getCompatibilityMatrixEntry_MappingType()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.CompatibilityMatrixEntry#getMappingType <em>Mapping Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link lemma.adapted.xcore.technology.PossiblyImportedTechnologySpecificType}.
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.technology.PossiblyImportedTechnologySpecificType#getCompatibleEntry <em>Compatible Entry</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Compatible Types</em>' containment reference list.
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getCompatibilityMatrixEntry_CompatibleTypes()
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.technology.Technology#getCompatibilityEntries <em>Compatibility Entries</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Technology</em>' container reference.
	 * @see #setTechnology(Technology)
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getCompatibilityMatrixEntry_Technology()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.CompatibilityMatrixEntry#getTechnology <em>Technology</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
