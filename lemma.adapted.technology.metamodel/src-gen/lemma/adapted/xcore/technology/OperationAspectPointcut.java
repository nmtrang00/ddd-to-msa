 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.technology.OperationAspectPointcut#isForTechnology <em>For Technology</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.OperationAspectPointcut#getTechnology <em>Technology</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.OperationAspectPointcut#getSelector <em>Selector</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.OperationAspectPointcut#getEffectiveType <em>Effective Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.OperationAspectPointcut#getEffectiveSelectorName <em>Effective Selector Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.OperationAspectPointcut#getEffectiveValue <em>Effective Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.OperationAspectPointcut#getPrintableEffectiveValue <em>Printable Effective Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.OperationAspectPointcut#getOrderedPointcutTypes <em>Ordered Pointcut Types</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationAspectPointcut()
 * @model
 * @generated
 */
public interface OperationAspectPointcut extends EObject {
	 ...
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationAspectPointcut_ForTechnology()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.OperationAspectPointcut#isForTechnology <em>For Technology</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationAspectPointcut_Technology()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.OperationAspectPointcut#getTechnology <em>Technology</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.technology.OperationAspectPointcutSelector#getPointcuts <em>Pointcuts</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Selector</em>' container reference.
	 * @see #setSelector(OperationAspectPointcutSelector)
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationAspectPointcut_Selector()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.OperationAspectPointcut#getSelector <em>Selector</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationAspectPointcut_EffectiveType()
	 ...
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationAspectPointcut_EffectiveSelectorName()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	 ...
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationAspectPointcut_EffectiveValue()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	 ...
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationAspectPointcut_PrintableEffectiveValue()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	 ...
	 * @see lemma.adapted.xcore.technology.PointcutType
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationAspectPointcut_OrderedPointcutTypes()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
