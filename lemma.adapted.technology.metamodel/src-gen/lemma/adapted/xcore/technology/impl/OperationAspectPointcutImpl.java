 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.technology.impl.OperationAspectPointcutImpl#isForTechnology <em>For Technology</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.OperationAspectPointcutImpl#getTechnology <em>Technology</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.OperationAspectPointcutImpl#getSelector <em>Selector</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.OperationAspectPointcutImpl#getEffectiveType <em>Effective Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.OperationAspectPointcutImpl#getEffectiveSelectorName <em>Effective Selector Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.OperationAspectPointcutImpl#getEffectiveValue <em>Effective Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.OperationAspectPointcutImpl#getPrintableEffectiveValue <em>Printable Effective Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.OperationAspectPointcutImpl#getOrderedPointcutTypes <em>Ordered Pointcut Types</em>}</li>
 * </ul>
 *
 * @generated
 */
