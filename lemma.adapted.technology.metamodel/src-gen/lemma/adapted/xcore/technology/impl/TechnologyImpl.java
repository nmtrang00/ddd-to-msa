 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.technology.impl.TechnologyImpl#getName <em>Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.TechnologyImpl#getImports <em>Imports</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.TechnologyImpl#getPrimitiveTypes <em>Primitive Types</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.TechnologyImpl#getCollectionTypes <em>Collection Types</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.TechnologyImpl#getDataStructures <em>Data Structures</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.TechnologyImpl#getCompatibilityEntries <em>Compatibility Entries</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.TechnologyImpl#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.TechnologyImpl#getServiceAspects <em>Service Aspects</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.TechnologyImpl#getDeploymentTechnologies <em>Deployment Technologies</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.TechnologyImpl#getInfrastructureTechnologies <em>Infrastructure Technologies</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.TechnologyImpl#getOperationAspects <em>Operation Aspects</em>}</li>
 * </ul>
 *
 * @generated
 */
