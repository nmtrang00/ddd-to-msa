...
public class ActivityItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DactPackage.eINSTANCE.getBehavior_Specification(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DactPackage.eINSTANCE.getActivity_ToTransform(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DactPackage.eINSTANCE.getActivity_OwnedParameters());
			childrenFeatures.add(DactPackage.eINSTANCE.getActivity_ParameterMappings());
			childrenFeatures.add(DactPackage.eINSTANCE.getActivity_Root());
			childrenFeatures.add(DactPackage.eINSTANCE.getActivity_OwnedDomainNodes());
			childrenFeatures.add(DactPackage.eINSTANCE.getActivity_ProcessedDomainNodeMappings());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getActivity_OwnedParameters(),
				 DactFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getActivity_ParameterMappings(),
				 DactFactory.eINSTANCE.createParameterMapping()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getActivity_Root(),
				 DactFactory.eINSTANCE.createActivityGroup()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getActivity_Root(),
				 DactFactory.eINSTANCE.createParallelFlow()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getActivity_OwnedDomainNodes(),
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getActivity_ProcessedDomainNodeMappings(),
