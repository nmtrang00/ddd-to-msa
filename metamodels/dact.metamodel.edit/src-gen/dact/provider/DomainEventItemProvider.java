...
/**
 * This is the item provider adapter for a {@link dact.DomainEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainEventItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DactPackage.eINSTANCE.getDomainElement_Context(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DactPackage.eINSTANCE.getSharedDomainObject_AbstractedRoot(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DactPackage.eINSTANCE.getDomainObject_OwnedProperties());
			childrenFeatures.add(DactPackage.eINSTANCE.getDomainObject_OwnedOperations());
			childrenFeatures.add(DactPackage.eINSTANCE.getDomainObject_Scope());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getDomainObject_OwnedProperties(),
				 DactFactory.eINSTANCE.createProperty()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getDomainObject_OwnedOperations(),
				 DactFactory.eINSTANCE.createOperation()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getDomainObject_OwnedOperations(),
				 DactFactory.eINSTANCE.createSpecOperation()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getDomainObject_Scope(),
