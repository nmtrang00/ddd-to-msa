...
/**
 * This is the item provider adapter for a {@link dact.SharedDomainObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SharedDomainObjectItemProvider extends DomainObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SharedDomainObjectItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SharedDomainObject)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SharedDomainObject_type") :
			getString("_UI_SharedDomainObject_type") + " " + label;
	}
