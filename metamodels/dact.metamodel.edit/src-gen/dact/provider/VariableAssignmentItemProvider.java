...
/**
 * This is the item provider adapter for a {@link dact.VariableAssignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableAssignmentItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DactPackage.eINSTANCE.getVariableAssignment_Identifier());
			childrenFeatures.add(DactPackage.eINSTANCE.getVariableAssignment_Expr());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VariableAssignment.class)) {
			case DactPackage.VARIABLE_ASSIGNMENT__IDENTIFIER:
			case DactPackage.VARIABLE_ASSIGNMENT__EXPR:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getVariableAssignment_Identifier(),
				 DactFactory.eINSTANCE.createIdentifier()));

		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getVariableAssignment_Expr(),
