...
/**
 * This is the item provider adapter for a {@link dact.VariableDeclarationAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableDeclarationActionItemProvider extends ExecutableNodeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableDeclarationAction_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableDeclarationAction_type_feature", "_UI_VariableDeclarationAction_type"),
				 DactPackage.eINSTANCE.getVariableDeclarationAction_Type(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DactPackage.eINSTANCE.getVariableDeclarationAction_UpperBound(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DactPackage.eINSTANCE.getVariableDeclarationAction_LowerBound(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DactPackage.eINSTANCE.getVariableDeclarationAction_Declaration());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DactPackage.eINSTANCE.getVariableDeclarationAction_Declaration(),
