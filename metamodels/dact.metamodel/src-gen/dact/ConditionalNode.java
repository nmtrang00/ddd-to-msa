 ...
 * </p>
 * <ul>
 *   <li>{@link dact.ConditionalNode#getElseBody <em>Else Body</em>}</li>
 * </ul>
 *
 * @see dact.DactPackage#getConditionalNode()
 * @model
 * @generated
 */
public interface ConditionalNode extends StructuredActivityNode {
	 ...
	 * It is bidirectional and its opposite is '{@link dact.ActivityGroup#getConditionalNode <em>Conditional Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Else Body</em>' containment reference.
	 * @see #setElseBody(ActivityGroup)
	 * @see dact.DactPackage#getConditionalNode_ElseBody()
	...
	/**
	 * Sets the value of the '{@link dact.ConditionalNode#getElseBody <em>Else Body</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
