...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Activity Model</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dact.impl.ActivityModelImpl#getActivities <em>Activities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActivityModelImpl extends ModelImpl implements ActivityModel {
	/**
	...
	protected EClass eStaticClass() {
		return DactPackage.eINSTANCE.getActivityModel();
	}
	...
	public EList<Activity> getActivities() {
		if (activities == null) {
			activities = new EObjectContainmentEList<Activity>(Activity.class, this, DactPackage.ACTIVITY_MODEL__ACTIVITIES);
		}
		return activities;
	}
	...
	public boolean UniqueActivityNames(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final List<String> names = IterableExtensions.<String>toList(IterableExtensions.<String>filterNull(XcoreEListExtensions.<Activity, String>map(this.getActivities(), _function)));
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == DiagnosticSupported.class) {
			switch (baseOperationID) {
				case DactPackage.DIAGNOSTIC_SUPPORTED___REPORT__DIAGNOSTICCHAIN_STRING_STRING: return DactPackage.ACTIVITY_MODEL___REPORT__DIAGNOSTICCHAIN_STRING_STRING;
				case DactPackage.DIAGNOSTIC_SUPPORTED___WARN__DIAGNOSTICCHAIN_STRING_STRING: return DactPackage.ACTIVITY_MODEL___WARN__DIAGNOSTICCHAIN_STRING_STRING;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DactPackage.ACTIVITY_MODEL___UNIQUE_ACTIVITY_NAMES__DIAGNOSTICCHAIN_MAP:
				return UniqueActivityNames((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case DactPackage.ACTIVITY_MODEL___REPORT__DIAGNOSTICCHAIN_STRING_STRING:
				return report((DiagnosticChain)arguments.get(0), (String)arguments.get(1), (String)arguments.get(2));
			case DactPackage.ACTIVITY_MODEL___WARN__DIAGNOSTICCHAIN_STRING_STRING:
