 ...
 * </p>
 * <ul>
 *   <li>{@link dact.impl.BehaviorImpl#getSpecification <em>Specification</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BehaviorImpl extends MinimalEObjectImpl.Container implements Behavior {
	...
	protected EClass eStaticClass() {
		return DactPackage.eINSTANCE.getBehavior();
	}
		...
		if (specification != null && specification.eIsProxy()) {
			...
			if (specification != oldSpecification) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DactPackage.BEHAVIOR__SPECIFICATION, oldSpecification, specification));
			}
		}
	...
	public NotificationChain basicSetSpecification(Operation newSpecification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DactPackage.BEHAVIOR__SPECIFICATION, oldSpecification, newSpecification);
	...
	public void setSpecification(Operation newSpecification) {
		if (newSpecification != specification) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DactPackage.BEHAVIOR__SPECIFICATION, newSpecification, newSpecification));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DactPackage.BEHAVIOR__SPECIFICATION:
				if (specification != null)
					msgs = ((InternalEObject)specification).eInverseRemove(this, DactPackage.OPERATION__BEHAVIOR, Operation.class, msgs);
