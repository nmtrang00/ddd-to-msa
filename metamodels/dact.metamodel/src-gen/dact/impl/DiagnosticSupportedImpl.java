...
public abstract class DiagnosticSupportedImpl extends MinimalEObjectImpl.Container implements DiagnosticSupported {
	...
	protected EClass eStaticClass() {
		return DactPackage.eINSTANCE.getDiagnosticSupported();
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DactPackage.DIAGNOSTIC_SUPPORTED___REPORT__DIAGNOSTICCHAIN_STRING_STRING:
				return report((DiagnosticChain)arguments.get(0), (String)arguments.get(1), (String)arguments.get(2));
			case DactPackage.DIAGNOSTIC_SUPPORTED___WARN__DIAGNOSTICCHAIN_STRING_STRING:
