...
/**
 * This is the item provider adapter for a {@link lemma.adapted.xcore.behavior.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BehaviorPackage.Literals.ACTIVITY__TO_TRANSFORM,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BehaviorPackage.Literals.BEHAVIOR__SPECIFICATION);
			childrenFeatures.add(BehaviorPackage.Literals.ACTIVITY__OWNED_PARAMETERS);
			childrenFeatures.add(BehaviorPackage.Literals.ACTIVITY__PARAMETER_MAPPINGS);
			childrenFeatures.add(BehaviorPackage.Literals.ACTIVITY__ROOT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.BEHAVIOR__SPECIFICATION,
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.ACTIVITY__OWNED_PARAMETERS,
				 ServiceFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.ACTIVITY__PARAMETER_MAPPINGS,
				 BehaviorFactory.eINSTANCE.createParameterMapping()));

		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.ACTIVITY__ROOT,
