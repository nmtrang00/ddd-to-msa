	...
	protected void addDataModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComplexType_dataModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComplexType_dataModel_feature", "_UI_ComplexType_type"),
				 DataPackage.Literals.COMPLEX_TYPE__DATA_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComplexType_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComplexType_version_feature", "_UI_ComplexType_type"),
				 DataPackage.Literals.COMPLEX_TYPE__VERSION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComplexType_context_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComplexType_context_feature", "_UI_ComplexType_type"),
				 DataPackage.Literals.COMPLEX_TYPE__CONTEXT,
				 true,
				 false,
				 true,
				 null,
