	...
	protected void addLowerBoundPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataField_lowerBound_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataField_lowerBound_feature", "_UI_DataField_type"),
				 DataPackage.Literals.DATA_FIELD__LOWER_BOUND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUpperBoundPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataField_upperBound_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataField_upperBound_feature", "_UI_DataField_type"),
				 DataPackage.Literals.DATA_FIELD__UPPER_BOUND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDataStructurePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataField_dataStructure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataField_dataStructure_feature", "_UI_DataField_type"),
				 DataPackage.Literals.DATA_FIELD__DATA_STRUCTURE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCollectionTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataField_collectionType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataField_collectionType_feature", "_UI_DataField_type"),
				 DataPackage.Literals.DATA_FIELD__COLLECTION_TYPE,
				 true,
				 false,
				 true,
				 null,
