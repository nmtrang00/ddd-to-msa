...
/**
 * This is the item provider adapter for a {@link lemma.adapted.xcore.data.DataStructure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataStructureItemProvider extends ComplexTypeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataStructure_super_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataStructure_super_feature", "_UI_DataStructure_type"),
				 DataPackage.Literals.DATA_STRUCTURE__SUPER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DataPackage.Literals.DATA_STRUCTURE__DATA_FIELDS);
			childrenFeatures.add(DataPackage.Literals.DATA_STRUCTURE__OPERATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DataPackage.Literals.DATA_STRUCTURE__DATA_FIELDS,
				 DataFactory.eINSTANCE.createDataField()));

		newChildDescriptors.add
			(createChildParameter
				(DataPackage.Literals.DATA_STRUCTURE__OPERATIONS,
				 DataFactory.eINSTANCE.createDataOperation()));
	}
