...
/**
 * This is the item provider adapter for a {@link lemma.adapted.xcore.data.Version} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VersionItemProvider 
	...
	protected void addDataModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Version_dataModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Version_dataModel_feature", "_UI_Version_type"),
				 DataPackage.Literals.VERSION__DATA_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DataPackage.Literals.VERSION__COMPLEX_TYPES);
			childrenFeatures.add(DataPackage.Literals.VERSION__CONTEXTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DataPackage.Literals.VERSION__COMPLEX_TYPES,
		...
		newChildDescriptors.add
			(createChildParameter
				(DataPackage.Literals.VERSION__CONTEXTS,
