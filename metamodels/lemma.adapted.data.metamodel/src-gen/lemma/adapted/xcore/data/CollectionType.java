 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.data.CollectionType#getPrimitiveType <em>Primitive Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.CollectionType#getDataFields <em>Data Fields</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.data.DataPackage#getCollectionType()
 * @model
 * @generated
 */
public interface CollectionType extends ComplexType {
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getCollectionType_PrimitiveType()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.CollectionType#getPrimitiveType <em>Primitive Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.data.DataField#getCollectionType <em>Collection Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Data Fields</em>' containment reference list.
	 * @see lemma.adapted.xcore.data.DataPackage#getCollectionType_DataFields()
