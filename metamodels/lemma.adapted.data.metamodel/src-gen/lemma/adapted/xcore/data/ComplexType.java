 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.data.ComplexType#getName <em>Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.ComplexType#getFeatures <em>Features</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.ComplexType#getDataModel <em>Data Model</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.ComplexType#getVersion <em>Version</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.ComplexType#getContext <em>Context</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.ComplexType#isIsStructure <em>Is Structure</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.ComplexType#isIsPrimitiveCollection <em>Is Primitive Collection</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.ComplexType#isIsStructuredCollection <em>Is Structured Collection</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.ComplexType#isIsEnumeration <em>Is Enumeration</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.data.DataPackage#getComplexType()
 * @model abstract="true"
 * @generated
 */
public interface ComplexType extends Type {
	 ...
	 * @see #setName(String)
	 * @see lemma.adapted.xcore.data.DataPackage#getComplexType_Name()
	 * @model unique="false"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.ComplexType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link lemma.adapted.xcore.data.ComplexTypeFeature}.
	 * The literals are from the enumeration {@link lemma.adapted.xcore.data.ComplexTypeFeature}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Features</em>' attribute list.
	 * @see lemma.adapted.xcore.data.ComplexTypeFeature
	 * @see lemma.adapted.xcore.data.DataPackage#getComplexType_Features()
	 * @model unique="false"
	 * @generated
	 */
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.data.DataModel#getComplexTypes <em>Complex Types</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Data Model</em>' container reference.
	 * @see #setDataModel(DataModel)
	 * @see lemma.adapted.xcore.data.DataPackage#getComplexType_DataModel()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.ComplexType#getDataModel <em>Data Model</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.data.Version#getComplexTypes <em>Complex Types</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Version</em>' container reference.
	 * @see #setVersion(Version)
	 * @see lemma.adapted.xcore.data.DataPackage#getComplexType_Version()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.ComplexType#getVersion <em>Version</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.data.Context#getComplexTypes <em>Complex Types</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Context</em>' container reference.
	 * @see #setContext(Context)
	 * @see lemma.adapted.xcore.data.DataPackage#getComplexType_Context()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.data.ComplexType#getContext <em>Context</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getComplexType_IsStructure()
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getComplexType_IsPrimitiveCollection()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getComplexType_IsStructuredCollection()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	 ...
	 * @see lemma.adapted.xcore.data.DataPackage#getComplexType_IsEnumeration()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
