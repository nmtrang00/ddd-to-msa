 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.data.impl.ComplexTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.ComplexTypeImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.ComplexTypeImpl#getDataModel <em>Data Model</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.ComplexTypeImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.ComplexTypeImpl#getContext <em>Context</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.ComplexTypeImpl#isIsStructure <em>Is Structure</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.ComplexTypeImpl#isIsPrimitiveCollection <em>Is Primitive Collection</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.ComplexTypeImpl#isIsStructuredCollection <em>Is Structured Collection</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.ComplexTypeImpl#isIsEnumeration <em>Is Enumeration</em>}</li>
 * </ul>
 *
 * @generated
 */
