 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataFieldImpl#getName <em>Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataFieldImpl#isHidden <em>Hidden</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataFieldImpl#isImmutable <em>Immutable</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataFieldImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataFieldImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataFieldImpl#getComplexType <em>Complex Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataFieldImpl#getImportedComplexType <em>Imported Complex Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataFieldImpl#getPrimitiveType <em>Primitive Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataFieldImpl#getInitializationValue <em>Initialization Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataFieldImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataFieldImpl#getDataStructure <em>Data Structure</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.DataFieldImpl#getCollectionType <em>Collection Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataFieldImpl extends MinimalEObjectImpl.Container implements DataField {
	...
	public void setLowerBound(Integer newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.DATA_FIELD__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(Integer newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.DATA_FIELD__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DataPackage.DATA_FIELD__IMMUTABLE:
				return isImmutable();
			case DataPackage.DATA_FIELD__LOWER_BOUND:
				return getLowerBound();
			case DataPackage.DATA_FIELD__UPPER_BOUND:
