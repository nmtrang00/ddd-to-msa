 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.data.impl.PrimitiveTypeImpl#getTypeName <em>Type Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.data.impl.PrimitiveTypeImpl#getTypeSize <em>Type Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PrimitiveTypeImpl extends TypeImpl implements PrimitiveType {
	...
	public int sizeCompare(final PrimitiveType typeToCompare) {
		...
		if (((this.getTypeName() != null) && Objects.equals(this.getTypeName(), typeToCompare.getTypeName()))) {
			return 0;
		}
	...
	public boolean isCompatibleWith(final PrimitiveType typeToCheck) {
		...
		if (((typeToCheck != null) && Objects.equals(typeToCheck.getTypeName(), this.getTypeName()))) {
			return true;
		}
