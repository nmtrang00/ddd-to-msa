 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.service.TechnologyReference#isIsTypeDefinitionTechnology <em>Is Type Definition Technology</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.TechnologyReference#getTechnology <em>Technology</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.TechnologyReference#getMicroservice <em>Microservice</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.TechnologyReference#getMappedComplexType <em>Mapped Complex Type</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.service.ServicePackage#getTechnologyReference()
 * @model
 * @generated
 */
public interface TechnologyReference extends EObject {
	 ...
	 * @see lemma.adapted.xcore.service.ServicePackage#getTechnologyReference_IsTypeDefinitionTechnology()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.TechnologyReference#isIsTypeDefinitionTechnology <em>Is Type Definition Technology</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.service.ServicePackage#getTechnologyReference_Technology()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.TechnologyReference#getTechnology <em>Technology</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.service.Microservice#getTechnologyReferences <em>Technology References</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Microservice</em>' container reference.
	 * @see #setMicroservice(Microservice)
	 * @see lemma.adapted.xcore.service.ServicePackage#getTechnologyReference_Microservice()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.TechnologyReference#getMicroservice <em>Microservice</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.service.MappedComplexType#getTechnologyReferences <em>Technology References</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Mapped Complex Type</em>' container reference.
	 * @see #setMappedComplexType(MappedComplexType)
	 * @see lemma.adapted.xcore.service.ServicePackage#getTechnologyReference_MappedComplexType()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.service.TechnologyReference#getMappedComplexType <em>Mapped Complex Type</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
