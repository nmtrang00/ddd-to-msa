 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.service.impl.MappedComplexTypeImpl#getT_sourceModelUri <em>Tsource Model Uri</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MappedComplexTypeImpl#getT_mappingModelUri <em>Tmapping Model Uri</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MappedComplexTypeImpl#getT_typeDefinitionTechnologyImport <em>Ttype Definition Technology Import</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MappedComplexTypeImpl#getT_typeDefinitionTechnology <em>Ttype Definition Technology</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MappedComplexTypeImpl#getTechnologyReferences <em>Technology References</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MappedComplexTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MappedComplexTypeImpl#getMappedFields <em>Mapped Fields</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MappedComplexTypeImpl#getMappedOperations <em>Mapped Operations</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MappedComplexTypeImpl#getAspects <em>Aspects</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.MappedComplexTypeImpl#getServiceModel <em>Service Model</em>}</li>
 * </ul>
 *
 * @generated
 */
