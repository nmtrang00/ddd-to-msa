 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#isToExpose <em>To Expose</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#isNotImplemented <em>Not Implemented</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#getOperationType <em>Operation Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#getApiOperationComment <em>Api Operation Comment</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#getEndpoints <em>Endpoints</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#getAspects <em>Aspects</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#getInterface <em>Interface</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#isNotImplementedByContainer <em>Not Implemented By Container</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#isEffectivelyNotImplemented <em>Effectively Not Implemented</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#getEffectiveVisibility <em>Effective Visibility</em>}</li>
 *   <li>{@link lemma.adapted.xcore.service.impl.OperationImpl#isEffectivelyInternal <em>Effectively Internal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationImpl extends MinimalEObjectImpl.Container implements Operation {
	 ...
	 * @ordered
	 */
	protected static final OperationType OPERATION_TYPE_EDEFAULT = OperationType.I0_INBOUND_GET;
	...
	public void setToExpose(boolean newToExpose) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.OPERATION__TO_EXPOSE, oldToExpose, toExpose));
	}
	...
	public void setOperationType(OperationType newOperationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.OPERATION__OPERATION_TYPE, oldOperationType, operationType));
	}
