...
public class ServiceFactoryImpl extends EFactoryImpl implements ServiceFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ServicePackage.INTERFACE_TYPE:
				return createInterfaceTypeFromString(eDataType, initialValue);
			case ServicePackage.OPERATION_TYPE:
				return createOperationTypeFromString(eDataType, initialValue);
			case ServicePackage.ADAPTER_PARAMETER_TYPE:
				return createAdapterParameterTypeFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ServicePackage.ADAPTER_PARAMETER_TYPE:
				return convertAdapterParameterTypeToString(eDataType, instanceValue);
			case ServicePackage.TUPLE_LIST:
	 ...
	 * @generated
	 */
	public AdapterParameterType createAdapterParameterTypeFromString(EDataType eDataType, String initialValue) {
		AdapterParameterType result = AdapterParameterType.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertAdapterParameterTypeToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
