...
public class ServicePackageImpl extends EPackageImpl implements ServicePackage {
	...
	public EAttribute getOperation_EffectivelyInternal() {
		return (EAttribute)operationEClass.getEStructuralFeatures().get(14);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(operationEClass, OPERATION__TO_EXPOSE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getOperation_ToExpose(), theEcorePackage.getEBoolean(), "toExpose", "false", 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
