...
/**
 * This is the item provider adapter for a {@link lemma.adapted.xcore.technology.Protocol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProtocolItemProvider 
	...
	protected void addCommunicationTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Protocol_communicationType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Protocol_communicationType_feature", "_UI_Protocol_type"),
				 TechnologyPackage.Literals.PROTOCOL__COMMUNICATION_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDefaultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Protocol_default_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Protocol_default_feature", "_UI_Protocol_type"),
				 TechnologyPackage.Literals.PROTOCOL__DEFAULT,
				 true,
				 false,
				 false,
	...
	protected void addDefaultFormatPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Protocol_defaultFormat_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Protocol_defaultFormat_feature", "_UI_Protocol_type"),
				 TechnologyPackage.Literals.PROTOCOL__DEFAULT_FORMAT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTechnologyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Protocol_technology_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Protocol_technology_feature", "_UI_Protocol_type"),
				 TechnologyPackage.Literals.PROTOCOL__TECHNOLOGY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TechnologyPackage.Literals.PROTOCOL__DATA_FORMATS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TechnologyPackage.Literals.PROTOCOL__DATA_FORMATS,
				 TechnologyFactory.eINSTANCE.createDataFormat()));
	}
