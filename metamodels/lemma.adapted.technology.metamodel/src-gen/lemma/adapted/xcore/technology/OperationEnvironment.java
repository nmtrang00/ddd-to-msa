 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.technology.OperationEnvironment#getEnvironmentName <em>Environment Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.OperationEnvironment#isDefault <em>Default</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.OperationEnvironment#getOperationTechnology <em>Operation Technology</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationEnvironment()
 * @model
 * @generated
 */
public interface OperationEnvironment extends EObject {
	 ...
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationEnvironment_EnvironmentName()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.OperationEnvironment#getEnvironmentName <em>Environment Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationEnvironment_Default()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.OperationEnvironment#isDefault <em>Default</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.technology.OperationTechnology#getOperationEnvironments <em>Operation Environments</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Operation Technology</em>' container reference.
	 * @see #setOperationTechnology(OperationTechnology)
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getOperationEnvironment_OperationTechnology()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.OperationEnvironment#getOperationTechnology <em>Operation Technology</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
