 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.technology.ServiceAspect#getPointcutSelectors <em>Pointcut Selectors</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.ServiceAspect#getTechnology <em>Technology</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.technology.TechnologyPackage#getServiceAspect()
 * @model
 * @generated
 */
public interface ServiceAspect extends TechnologyAspect {
	 ...
	 * The list contents are of type {@link lemma.adapted.xcore.technology.ServiceAspectPointcutSelector}.
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.technology.ServiceAspectPointcutSelector#getServiceAspect <em>Service Aspect</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * *
	 ...
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getServiceAspect_PointcutSelectors()
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.technology.Technology#getServiceAspects <em>Service Aspects</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Technology</em>' container reference.
	 * @see #setTechnology(Technology)
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getServiceAspect_Technology()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.ServiceAspect#getTechnology <em>Technology</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
