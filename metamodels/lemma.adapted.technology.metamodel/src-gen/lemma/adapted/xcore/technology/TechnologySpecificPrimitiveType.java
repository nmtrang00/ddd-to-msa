 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.technology.TechnologySpecificPrimitiveType#getName <em>Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.TechnologySpecificPrimitiveType#isDefault <em>Default</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.TechnologySpecificPrimitiveType#getTechnology <em>Technology</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.TechnologySpecificPrimitiveType#getBasicBuiltinPrimitiveTypes <em>Basic Builtin Primitive Types</em>}</li>
 * </ul>
 *
 * @see lemma.adapted.xcore.technology.TechnologyPackage#getTechnologySpecificPrimitiveType()
 * @model
 * @generated
 */
public interface TechnologySpecificPrimitiveType extends PrimitiveType {
	 ...
	 * @see #setName(String)
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getTechnologySpecificPrimitiveType_Name()
	 * @model unique="false"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.TechnologySpecificPrimitiveType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getTechnologySpecificPrimitiveType_Default()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.TechnologySpecificPrimitiveType#isDefault <em>Default</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link lemma.adapted.xcore.technology.Technology#getPrimitiveTypes <em>Primitive Types</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Technology</em>' container reference.
	 * @see #setTechnology(Technology)
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getTechnologySpecificPrimitiveType_Technology()
	...
	/**
	 * Sets the value of the '{@link lemma.adapted.xcore.technology.TechnologySpecificPrimitiveType#getTechnology <em>Technology</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link lemma.adapted.xcore.data.PrimitiveType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Basic Builtin Primitive Types</em>' containment reference list.
	 * @see lemma.adapted.xcore.technology.TechnologyPackage#getTechnologySpecificPrimitiveType_BasicBuiltinPrimitiveTypes()
