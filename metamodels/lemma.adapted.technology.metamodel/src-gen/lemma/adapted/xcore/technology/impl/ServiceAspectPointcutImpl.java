/**
 */
package lemma.adapted.xcore.technology.impl;
 ...
 * </p>
 * <ul>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#isForExchangePattern <em>For Exchange Pattern</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#isForCommunicationType <em>For Communication Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#isForProtocol <em>For Protocol</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#isForDataFormat <em>For Data Format</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#getExchangePattern <em>Exchange Pattern</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#getCommunicationType <em>Communication Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#getProtocol <em>Protocol</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#getDataFormat <em>Data Format</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#getSelector <em>Selector</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#getEffectiveType <em>Effective Type</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#getEffectiveSelectorName <em>Effective Selector Name</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#getEffectiveValue <em>Effective Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#getPrintableEffectiveValue <em>Printable Effective Value</em>}</li>
 *   <li>{@link lemma.adapted.xcore.technology.impl.ServiceAspectPointcutImpl#getOrderedPointcutTypes <em>Ordered Pointcut Types</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public String getPrintableEffectiveValue() {
		...
		if (((this.getEffectiveType() == PointcutType.EXCHANGE_PATTERN) && (this.getExchangePattern() != null))) {
			...
			if (((this.getEffectiveType() == PointcutType.COMMUNICATION_TYPE) && 
				Objects.equals(CommunicationType.ASYNCHRONOUS, this.getCommunicationType()))) {
				_xifexpression_1 = "async";
			}
			else {
				String _xifexpression_2 = null;
				if (((this.getEffectiveType() == PointcutType.COMMUNICATION_TYPE) && 
					Objects.equals(CommunicationType.SYNCHRONOUS, this.getCommunicationType()))) {
