...
public class StructuredActivityNodeServices {
    ...
    public ConditionalNode createANewConditionalNode(EObject object) {
    ...
    public void createANewParallelNode(EObject object) {
    	...
    	// Create a new body group
    	ParallelFlow body = DactFactory.eINSTANCE.createParallelFlow();
    	body.setName("Flow");
    ...
    public void createBody(ConditionalNode node) {
    	ActivityGroup body = DactFactory.eINSTANCE.createActivityGroup();
    	body.setName("Body (True)");
    	Scope bodyScope = DactFactory.eINSTANCE.createScope();
    	bodyScope.setParent(node.getGroup().getScope());
    	body.setScope(bodyScope);
    	node.setBody(body);
    }
    
    public void createElseBody(ConditionalNode node) {
    	ActivityGroup body = DactFactory.eINSTANCE.createActivityGroup();
    	body.setName("Else Body (False)");
    	Scope bodyScope = DactFactory.eINSTANCE.createScope();
    	bodyScope.setParent(node.getGroup().getScope());
    	body.setScope(bodyScope);
